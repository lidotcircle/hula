...
struct ClientConnectionProxy$_write$_write: public SBase {
    ClientConnectionProxy*               _this;
    ClientConnectionProxy::WriteCallback _cb;
    void*                                _data;
    inline ClientConnectionProxy$_write$_write(ClientConnectionProxy* _this, ClientConnectionProxy::WriteCallback cb, void* data):
