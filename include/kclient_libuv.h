...
class UVMultiplexer: public EBStreamUV, public ConnectionProxy {
    public:
...
class UVClientConnection: public EBStreamUV, public ClientConnection {
    public:
